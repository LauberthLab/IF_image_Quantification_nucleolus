...
from skimage import filters, morphology, measure, color, io as skio
from skimage.color import rgb2gray

from utils import parent_by_mode, normalize01, _ensure_dir, _save_gray, _save_label_tiff, overlay_labels, flatfield_correct
...
def main(
    ...
    #load PRECOMPUTED labels from previous step
...
#Confine nucleoli to nuclei and relabel
    ...
    #FBL/UBF segmentation (foci inside inner nucleus)
    ...
    #Per-nucleus Manders (NPM1;FBL/UBF)
    per_nuc_rows = []
